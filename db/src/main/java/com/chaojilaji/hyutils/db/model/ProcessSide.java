...
public class ProcessSide {
 ...
 private List<Long> idList; //orm层需要，无实际意义
    private String description;         //边描述 
    private Long processId;         //流程id 
    private Long fromNodeId;         //出度节点 
    private Long toNodeId;         //入度节点 
    private String sideType;         //边类型 
...
private ProcessSide target;

public Builder() {
            this.target = new ProcessSide();
        }

public ProcessSide build() {
            return target;
...
public Builder sideType(String sideType) {
            this.target.setSideType(sideType);
            return this;
        }
public Builder sideTypeLike(String sideType) {
if (Objects.isNull(sideType)){
                this.target.setSideType(sideType);
                return this;
            }
            this.target.setSideType(LikeParamExtension.PARAM_LEFT_LIKE + sideType + LikeParamExtension.PARAM_RIGHT_LIKE);
            return this;
        }

        public Builder sideTypeLeftLike(String sideType) {
if (Objects.isNull(sideType)){
                this.target.setSideType(sideType);
                return this;
            }
            this.target.setSideType(LikeParamExtension.PARAM_LEFT_LIKE + sideType);
            return this;
        }

        public Builder sideTypeRightLike(String sideType) {
if (Objects.isNull(sideType)){
                this.target.setSideType(sideType);
                return this;
            }
            this.target.setSideType(sideType + LikeParamExtension.PARAM_RIGHT_LIKE);
            return this;
        }
public Builder sideTypeNot(String sideType) {
                        if (Objects.isNull(sideType)){
                                        this.target.setSideType(sideType);
                                        return this;
                                    }
                                    this.target.setSideType("-1*"+sideType);
                                    return this;
                                }

...
//RBAC之功能表
public class SysFuncApis {
    private Long id;         //记录标识 
 private List<Long> idList; //orm层需要，无实际意义
    private String name;         //功能名 
    private String baseApiIds;         //组成功能的基础api的逗分id 
    private String description;         //描述 
    private String type;         //类型 
    private Long fatherId;         //上层功能id 
    private Long rank;         //功能展示的顺序 
...
public List<Long> getIdList() {
    ...
    public String getBaseApiIds() {
        return baseApiIds;
    }
    public void setBaseApiIds(String baseApiIds) {
        this.baseApiIds = baseApiIds;
    }
...
private SysFuncApis target;

public Builder() {
            this.target = new SysFuncApis();
        }

public SysFuncApis build() {
            return target;
...
public Builder baseApiIds(String baseApiIds) {
            this.target.setBaseApiIds(baseApiIds);
            return this;
        }
public Builder baseApiIdsLike(String baseApiIds) {
if (Objects.isNull(baseApiIds)){
                this.target.setBaseApiIds(baseApiIds);
                return this;
            }
            this.target.setBaseApiIds(LikeParamExtension.PARAM_LEFT_LIKE + baseApiIds + LikeParamExtension.PARAM_RIGHT_LIKE);
            return this;
        }

        public Builder baseApiIdsLeftLike(String baseApiIds) {
if (Objects.isNull(baseApiIds)){
                this.target.setBaseApiIds(baseApiIds);
                return this;
            }
            this.target.setBaseApiIds(LikeParamExtension.PARAM_LEFT_LIKE + baseApiIds);
            return this;
        }

        public Builder baseApiIdsRightLike(String baseApiIds) {
if (Objects.isNull(baseApiIds)){
                this.target.setBaseApiIds(baseApiIds);
                return this;
            }
            this.target.setBaseApiIds(baseApiIds + LikeParamExtension.PARAM_RIGHT_LIKE);
            return this;
        }
public Builder baseApiIdsNot(String baseApiIds) {
                        if (Objects.isNull(baseApiIds)){
                                        this.target.setBaseApiIds(baseApiIds);
                                        return this;
                                    }
                                    this.target.setBaseApiIds("-1*"+baseApiIds);
                                    return this;
                                }
...
public Builder rank(Long rank) {
            this.target.setRank(rank);
            return this;
        }
public Builder rankNot(Long rank) {
                        if (Objects.isNull(rank)){
                                        this.target.setRank(rank);
                                        return this;
                                    }
                                    this.target.setRank(-1L*rank);
                                    return this;
                                }

...
public class CompressionAndDecompressionUtils {
     ...
     */
    public static boolean tarCompression(List<String> filesPathArray, String resultFilePath) throws Exception {
     ...
     */
    public static boolean zipCompression(List<String> filesPathArray, String resultFilePath,Boolean absolute) throws Exception {
        ...
        if (absolute) {
            try {
                resultFilePath = directory.getCanonicalPath() + "/" + resultFilePath;
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
